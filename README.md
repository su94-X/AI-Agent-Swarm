...
<p align="center">
  <a href="https://github.com/su94-X/AI-Agent-Swarm/releases/tag/v1.5.2"><img alt="Release" src="https://img.shields.io/badge/release-v1.5.2-38BDF8"></a>
...
V1.5.2 是 Custom Agent 执行合同修复版本，延续 V1.5.0 的核心能力：`.codex/agents/*.toml` 官方 Custom Agent 模板、工程闸门、workspace 安全边界、本地项目记忆库、MCP 可见日志、patch/edit 局部编辑和安全发布包。本版特别强化：`primary-coder` 必须调用 Opus/Claude MCP 工具，`tester` 必须调用 Gemini MCP 工具，不能由 Codex 子智能体自己代替外部模型完成对应角色工作。

## 两个版本

| 版本 | 适合场景 | 外部模型角色 | Release |
| --- | --- | --- | --- |
| AI Agent Swarm | 完整多模型开发工作流 | Opus/Claude 主编码，Gemini 测试分析，Codex 内部审查 | [v1.5.2](https://github.com/su94-X/AI-Agent-Swarm/releases/tag/v1.5.2) |
...
1. 下载发布包：[ai-agent-swarm-1.5.2.zip](https://github.com/su94-X/AI-Agent-Swarm/releases/download/v1.5.2/ai-agent-swarm-1.5.2.zip)
...
- 主版本 Release：[AI Agent Swarm V1.5.2](https://github.com/su94-X/AI-Agent-Swarm/releases/tag/v1.5.2)
