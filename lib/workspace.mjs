...
export function applyWorkspaceEditPlan(args, context, editPlan) {
  ...
  for (const change of changes) {
    recordWorkspaceChange({ context, change, dryRun, changedFiles, changedFileDetails, diffs });
  }
...
function recordWorkspaceChange({ context, change, dryRun, changedFiles, changedFileDetails, diffs }) {
