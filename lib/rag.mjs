...
export function ragStatus() {
  ...
  return {
    ...
    updatedAt,
    notes: [
      "RAG is a Codex-controlled local project memory layer.",
      "Search results are candidate context. Codex must filter them before planning, editing, reviewing, testing, or final decisions.",
      "RAG storage must not be committed, packaged, or exposed to unrelated work.",
    ],
  };
}
