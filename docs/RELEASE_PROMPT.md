...
6. 确认 docs/README.md、docs/INSTALL_PROMPT.md、docs/START_PROMPT.md、docs/RELEASE_PROMPT.md、docs/OFFICIAL_DOCS_GATE.md 和 templates/ 存在。
...
- 包内路径统一使用 /。
- 包含 .codex/agents/*.toml、.env.example、README.md、docs/、templates/、skills/、scripts/、lib/、assets/、LICENSE、NOTICE。
