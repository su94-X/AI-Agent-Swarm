...
7. GitHub Release token 只能从环境变量或用户级凭据文件读取，不得写入仓库、.env、README、release note、RAG、issue、PR、截图或聊天记录。
...
- 包内路径统一使用 /。
- 包含 .env.example、README.md、docs/、skills/、scripts/、lib/、assets/、LICENSE、NOTICE。
