...
请检查：
1. .codex-plugin/plugin.json 可解析，version 为 1.4.9-lite.1。
...
7. 包内包含 docs/GITHUB_RELEASE_LITE_1.4.9-lite.1.md、scripts/sync-github-release.mjs、scripts/model-secret-self-test.mjs 和 lib/redaction.mjs。
8. 运行离线自检：
...
不要把 GitHub Release token 放入插件仓库、.env、README、RAG、issue、PR、截图或聊天记录。
