...
本文档记录 AI Agent Swarm 在 V1.4.9 正式版之后的工程改进方向，以及 V1.4.5/V1.4.6/V1.4.7/V1.4.8/V1.4.9 已完成的工程化事项。这里的未完成内容不是当前版本承诺，而是后续小版本或中版本的设计入口。
...
旧提示词文件保留为兼容 wrapper，至少保留一个小版本周期，后续可在确认外部链接迁移后移除。
